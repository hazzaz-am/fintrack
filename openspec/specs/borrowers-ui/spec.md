# borrowers-ui Specification

## Purpose

The Borrowers screen: listing borrowers with aggregate outstanding, and the add-borrower/lend/repay/write-off/change-due-date interactions backed by the `borrowers` capability.
